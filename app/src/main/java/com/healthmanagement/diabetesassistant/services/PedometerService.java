...
import com.healthmanagement.diabetesassistant.activities.MainActivity;
...
import com.healthmanagement.diabetesassistant.sensor.StepDetector;
import com.healthmanagement.diabetesassistant.sensor.interfaces.StepListener;
...
public class PedometerService extends Service implements SensorEventListener, StepListener
{
	...
	private static final String NOTIFICATION_CHANNEL_ID = "com.healthmanagement.diabetesassistant.steps";
	...
	private void logHourlySteps()
	{
		...
		if( lastHourSteps > 0 && currentLogHour != thisHour )
		{
			...
			getContentResolver().insert( DAContentProvider.PEDOMETER_URI, stepValues );
